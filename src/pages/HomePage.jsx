      ...
      <div className='flex w-screen pl-15 pr-15 overflow-hidden h-screen max-w-540'>
        <div className='flex flex-col items-center justify-center w-full md:w-6/10'>
          <div className='w-9/10 flex flex-col md:flex-row md:justify-around justify-center items-center gap-5'>
            ...
            <div className='flex gap-2 md:gap-0 flex-col justify-center'>
              <h2 className='text-[min(calc(1rem+1.5vw),4rem)] font-semibold ml-4 -mb-4 text-[#497345]'>Guess The Word</h2>
          ...
          <div className='flex flex-col md:flex-row justify-start p-5 items-center w-9/10 py-8 gap-7'>
            <button className='px-[min(7rem,(calc(1rem+4vw)))] py-4 bg-[#325b2e] text-2xl md:text-5xl min-h-9 min-w-60 md:min-h-18 font-bold text-[#d6fad3] rounded-4xl cursor-pointer hover:bg-[#294b26] duration-95'>Play</button>
