  ...
  return (
    <>
      <div className='flex w-screen pl-15 pr-15 overflow-hidden h-screen max-w-540'>
        <div className='flex flex-col items-center justify-center w-full lg:w-6/10'>
          <div className='w-9/10 flex flex-col lg:flex-row lg:justify-around justify-center items-center gap-5'>
            <img src={logo} className='lg:drop-shadow-[0_2px_0_#234120] dark:lg:drop-shadow-[0_2px_0_#1a1f24] drop-shadow-[0_1px_0_#234120] dark:drop-shadow-[0_1px_0_#1a1f24] lg:w-[calc(3rem+7vw)] w-[calc(5rem+7vw)] ' />
            <div className='flex gap-2 lg:gap-0 flex-col items-center lg:items-start'>
