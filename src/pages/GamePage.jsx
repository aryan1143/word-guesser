...
const GamePage = () => {
    ...
    return (
        <div className='relative mt-8 md:mt-0 flex flex-col items-center gap-5 md:gap-2 h-8/10 md:flex-1'>
            ...
            {hintBtn &&
                <button onClick={showHint} disabled={remainingHints <= 0} className={`relative pop-up-button block md:absolute md:bottom-20 right-2 p-3 text-3xl rounded-[50%] mt-auto -mb-15 ml-auto mr-5 disabled:opacity-50 text-[#234120] dark:text-[#e0e8f0] bg-[#acdda8] dark:bg-[#4a7c52] outline outline-[#00000057] dark:outline-[#ffffff7c]`}>
                    <FaLightbulb />
