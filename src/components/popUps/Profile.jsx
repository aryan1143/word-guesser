            ...
            <div className='flex flex-col items-center justify-center h-full lg:h-fit w-fit'>
              {isEditingName ? loading ? <Loader /> :
                <div className='flex justify-center w-full px-0.5'>
                  ...
                  <button disabled={name === ''} className=' cursor-pointer disabled:bg-[#81ae7d] dark:disabled:bg-[#3a4a38] text-[#acdda8] dark:text-[#e0e8f0] font-bold bg-[#234120] dark:bg-[#1a1f24] px-2' onClick={changeName}>✓</button>
                </div>
                :
