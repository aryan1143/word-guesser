...
const GameMode = () => {
  ...
  const { setTargetWord, resetWordleData, getDailyWordle } = useContext(WordsContext);
  ...
  return (
    <div className={`absolute top-0 left-0 z-30 h-screen w-screen bg-[#62626225] backdrop-blur-xs`}>
      <div className={`flex flex-col items-center pop-up w-9/10 h-6/10 -translate-y-10 lg:translate-y-0 lg:h-7/10 lg:w-55/100`}>
        ...
        <div className='relative overflow-hidden shadow-[0_4px_0_0_#234120] dark:shadow-[0_4px_0_0_#000000] flex flex-col lg:flex-row h-full w-full gap-2 lg:gap-5 justify-center items-center border rounded-t-none border-[#0000004d] dark:border-[rgba(255,255,255,0.1)] bg-[#d7ead5] dark:bg-[#1d2532] rounded-xl bg-[linear-gradient(rgba(35,65,32,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(35,65,32,0.05)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-size-[30px_30px]'>
          {!isLoggedIn && <div className="absolute flex flex-col gap-3 text-2xl justify-center items-center w-full h-full bg-[#ffffff4d] dark:bg-[#0000004d] z-100 backdrop-blur-md [text-shadow:1px_2px_0_#acdda8] dark:[text-shadow:1px_2px_0_#1a1f24]">
            <p className='dark:text-white text-[#234120]'>Login to access Gamemode</p>
          ...
          <div className={`relative shadow-[0_4px_0_0_#234120] dark:shadow-[0_4px_0_0_#000000] flex flex-row lg:flex-col items-evenly lg:items-center pt-3 justify-evenly w-9/10 h-3/10 lg:w-30/100 lg:h-9/10 rounded-xl bg-[#accda8] dark:bg-[#2a3942] ${didDailyWordle && 'opacity-80'}`}>
            {loading ? <Loader isBg={false} isText={false} /> : (
              <>
                <div className="shadow-[0_2px_0_0_#234120] dark:shadow-[0_2px_0_0_#000000] h-9/10 w-45/100 lg:h-4/10 lg:w-9/10 rounded-2xl bg-[#e2f0e0] dark:bg-[#3a5555] bg-[url('/bg-day.png')] bg-cover">
                  <p className='h-full w-full text-center flex items-center p-2 text-3xl lg:text-5xl text-[#234120] dark:text-[#e0e8f0]'>Word Of The Day</p>
                </div>
                <div className='flex-1 w-9/10 p-2 pt-4 hidden lg:flex flex-col gap-3 text-[1.25rem] text-[#0f2c0d] dark:text-[#b0bcc9]'>
                ...
                <div className='flex flex-col lg:flex-row w-45/100 lg:w-full justify-around p-3 pb-5 gap-3 text-xl'>
                  <button onClick={() => handlePlay('day')} className='flex-1 lg:w-[6vw] h-[calc(1rem+3vh)] bg-[#234120] dark:bg-[#6ab878] text-[#acdda8] dark:text-[#0f1419] cursor-pointer shadow-[0_3px_0_0_#acdda8] dark:shadow-[0_3px_0_0_#000000]'>Play</button>
                  <button className='flex-1 lg:w-[6vw] h-[calc(1rem+3vh)] text-[#234120] dark:text-[#e0e8f0] bg-[#acdda8] dark:bg-[#505a6b] cursor-pointer shadow-[0_2px_0_0_#234120] dark:shadow-[0_2px_0_0_#000000]'>Detail</button>
                </div>
              </>
            )}
          </div>
          <div className='shadow-[0_4px_0_0_#234120] dark:shadow-[0_4px_0_0_#000000] flex flex-row lg:flex-col items-evenly lg:items-center pt-3 justify-evenly w-9/10 h-3/10 lg:w-30/100 lg:h-9/10 rounded-xl bg-[#accda8] dark:bg-[#2a3942]'>
            <div className="shadow-[0_2px_0_0_#234120] dark:shadow-[0_2px_0_0_#000000] h-9/10 w-45/100 lg:h-4/10 lg:w-9/10 rounded-2xl bg-[#d7ead5] dark:bg-[#3a5555] bg-[url('/bg-friend.png')] bg-cover">
              <p className='h-full w-full text-center flex justify-center items-center p-2 text-3xl lg:text-5xl text-[#234120] dark:text-[#e0e8f0]'>Challange With Friend</p>
            </div>
            <div className='flex-1 w-9/10 p-2 pt-4 hidden lg:flex flex-col gap-3 text-[1.25rem] text-[#0f2c0d] dark:text-[#b0bcc9]'>
              <ul className='list-disc wrap-normal px-3 flex-col gap-1 [text-shadow:1px_1px_2px_#acdda8] dark:[text-shadow:1px_1px_2px_#1a1f24]'>
                <li>
            ...
            <div className='flex flex-col lg:flex-row w-45/100 lg:w-full justify-around p-3 pb-5 gap-3 text-xl'>
              <button onClick={() => handlePlay('challange')} className='flex-1 lg:w-[6vw] h-[calc(1rem+3vh)] bg-[#234120] dark:bg-[#6ab878] text-[#acdda8] dark:text-[#0f1419] cursor-pointer shadow-[0_3px_0_0_#acdda8] dark:shadow-[0_3px_0_0_#000000]'>Play</button>
              <button className='flex-1 lg:w-[6vw] h-[calc(1rem+3vh)] text-[#234120] dark:text-[#e0e8f0] bg-[#acdda8] dark:bg-[#505a6b] cursor-pointer shadow-[0_2px_0_0_#234120] dark:shadow-[0_2px_0_0_#000000]'>Detail</button>
            </div>
          </div>
          <div className='shadow-[0_4px_0_0_#234120] dark:shadow-[0_4px_0_0_#000000] flex flex-row lg:flex-col items-evenly lg:items-center pt-3 justify-evenly w-9/10 h-3/10 lg:w-30/100 lg:h-9/10 rounded-xl bg-[#accda8] dark:bg-[#2a3942]'>
            <div className="shadow-[0_2px_0_0_#234120] dark:shadow-[0_2px_0_0_#000000] h-9/10 w-45/100 lg:h-4/10 lg:w-9/10 rounded-2xl bg-[#d7ead5] dark:bg-[#3a5555] bg-[url('/bg-day.png')] bg-cover">
              <p className='h-full w-full text-center flex items-center p-2 text-3xl lg:text-5xl text-[#234120] dark:text-[#e0e8f0]'>Practice Words</p>
            </div>
            <div className='flex-1 w-9/10 p-2 pt-4 hidden lg:flex flex-col gap-3 text-[1.25rem] text-[#0f2c0d] dark:text-[#b0bcc9]'>
              <ul className='list-disc wrap-normal px-3 flex-col gap-1 [text-shadow:1px_1px_2px_#acdda8] dark:[text-shadow:1px_1px_2px_#1a1f24]'>
                <li>
            ...
            <div className='flex flex-col lg:flex-row w-45/100 lg:w-full justify-around p-3 pb-5 gap-3 text-xl'>
              <button onClick={() => handlePlay('practice')} className='flex-1 lg:w-[6vw] h-[calc(1rem+3vh)] bg-[#234120] dark:bg-[#6ab878] text-[#acdda8] dark:text-[#0f1419] cursor-pointer shadow-[0_3px_0_0_#acdda8] dark:shadow-[0_3px_0_0_#000000]'>Play</button>
              <button className='flex-1 lg:w-[6vw] h-[calc(1rem+3vh)] text-[#234120] dark:text-[#e0e8f0] bg-[#acdda8] dark:bg-[#505a6b] cursor-pointer shadow-[0_2px_0_0_#234120] dark:shadow-[0_2px_0_0_#000000]'>Detail</button>
            </div>
          </div>
        </div>
