...
const SignUp = () => {
    ...
    return (
        <div className={`text-[#234120] dark:text-[#e0e8f0] absolute top-0 left-0 z-30 h-screen w-screen bg-[#62626225] dark:bg-[rgba(0,0,0,0.4)] backdrop-blur-xs`}>
            <div className={`flex flex-col items-center pop-up w-8/10 h-fit -translate-y-10 md:translate-y-0 md:h-7/10 md:w-23/100`}>
                ...
                <div className='relative overflow-hidden shadow-[0_4px_0_0_#234120] dark:shadow-[0_4px_0_0_#000000] flex flex-col h-full w-full items-center border dark:border-[rgba(255,255,255,0.1)] border-[#0000004d] bg-[#d7ead5] dark:bg-[#1d2532] rounded-tr-none  rounded-xl bg-[linear-gradient(rgba(35,65,32,0.05)_1px,transparent_1px),linear-gradient(90deg,rgba(35,65,32,0.05)_1px,transparent_1px)] dark:bg-[linear-gradient(rgba(255,255,255,0.03)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.03)_1px,transparent_1px)] bg-size-[30px_30px]'>
                    ...
                    <div className='w-full h-7/10 md:h-65/100 p-3 pt-1 md:pt-5 flex flex-col items-center gap-5'>
                        ...
                        <p className='text-[#234120] dark:text-[#b0bcc9] -mt-2 md:mt-0'>Already have an account <span onClick={() => { setShowPopUp('Login') }} className='bg-[#acdda8] dark:bg-[#4a7c52] p-0.5 px-1 shadow-[1px_2px_0_0_#234120] dark:shadow-[1px_2px_0_0_#000000] dark:text-white cursor-pointer'>Login</span></p>
                    </div>
                </div>
            </div>
        </div>
